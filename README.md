# Starter Kit for Building Applications in React and Redux in ES6 based on redux-starter by Cory House.

## How to Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm) or [nvm-windows](https://github.com/coreybutler/nvm-windows)
2. **Clone this repository.** - `git clone https://github.com/clintlosee/redux-starter.git` or [download the zip](https://github.com/clintlosee/redux-starter/archive/master.zip)
